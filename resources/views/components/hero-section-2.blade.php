...
<div class="relative bg-gray-800 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
    <div class="absolute inset-0 overflow-hidden">
      <img src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/enUS/Images/horizontal-concepts-fw21-purpose-launch-clp-statement-v1-d_tcm221-819439.jpg" alt="" class="w-full h-full object-center object-cover">
    </div>

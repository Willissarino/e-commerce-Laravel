        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    You're logged in as Administrator and this is category page!
                </div>

                <!-- Button -->
                <div class="p-6 bg-white border-b border-gray-200">
                    <button type="button" onclick="location.href='{{ route ('administrator.add.categories') }}'"
                        ...
                        <tbody class="text-center">
                            @foreach ($category as $item)
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="location.href='{{ url('administrator/edit-category/'.$item->id) }}'"
                                        ...
                                        <button onclick="location.href='{{ url('administrator/delete-category/'.$item->id) }}'"
